...
public class Main {
    ...
    private static void displayTopologyDiagram() {
        ...
        System.out.println("       " + CYAN + "│" + RESET + "                        " + CYAN + "└──────────────────────────┐" + RESET + "   " + CYAN + "│" + RESET);
        System.out.println("       " + CYAN + "│" + RESET + "                                                      " + CYAN + "│" + RESET + "   " + CYAN + "│" + RESET);
        System.out.println("   " + BOLD + "Router-GedungA" + RESET + " ─────────── " + BOLD + "Router-GedungB" + RESET + " ─────────────────" + CYAN + "┼──" + RESET + " " + BOLD + "Router-Server" + RESET);
        System.out.println("                                                                    " + CYAN + "│" + RESET);
        System.out.println("                                                       (Pusat ── Server via ┼)");
        System.out.println("                                                       (ISP   ── Server via ┼)");
        System.out.println("");

        System.out.println("----------------------------------------------------------------------");
        System.out.println(BOLD + "Koneksi:" + RESET);
        System.out.println("  Router-Pusat  ───  Lab, GedungB, Server, ISP");
        System.out.println("  Router-Server ───  GedungB, Pusat, ISP");
        System.out.println("  Router-Lab    ───  GedungA, Pusat");
        System.out.println("  Router-GedungA ──  Lab, GedungB");
        System.out.println("  Router-GedungB ──  GedungA, Pusat, Server");
        System.out.println("  Router-ISP    ───  Pusat, Server");
        System.out.println("");
        System.out.println(BOLD + "Legenda:" + RESET);
        System.out.println("  ───  Kabel koneksi duplex (Undirected / timbal-balik)");
        System.out.println("  │    Koneksi vertikal antar router");
        System.out.println("  └─┐  Belokan koneksi");
        System.out.println("  ┼    Percabangan / pertemuan koneksi");
        System.out.println("");
        System.out.println(BOLD + "Algoritma:" + RESET);
        System.out.println("  DFS: PUSH saat kunjungi router, POP saat backtrack (Stack)");
        System.out.println("  BFS: Enqueue tetangga, Dequeue untuk diproses (Queue)");
        System.out.println("======================================================================");
        pressAnyKeyToContinue();
    }
